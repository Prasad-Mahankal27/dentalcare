...
export function Sidebar({
  ...
  const menuItems = isAdmin
    ? [
        { icon: LayoutDashboard, label: "Dashboard", path: "/admin", hasAdd: false },
        { icon: UserCog, label: "Users", path: "/admin/users", hasAdd: false }
      ]
    : [
    ...
    <>
      ...
      >
        ...
        <div className="px-3 py-4 space-y-1 border-t border-gray-100">
          <div
            onClick={() => {
              navigate(isAdmin ? "/admin/settings" : "/doctor/settings");
              onClose?.();
            }}
