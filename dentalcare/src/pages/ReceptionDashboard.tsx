...
export default function ReceptionDashboard({ user }: ReceptionDashboardProps) {
  ...
  async function fetchDayAppointments(day: Date, showLoader = true) {
    ...
    try {
      ...
      const res = await fetch(`http://127.0.0.1:4000/appointments/day?date=${requestedDate}`, {
        headers: {
  ...
  async function fetchAppointmentDates() {
    try {
      const res = await fetch("http://127.0.0.1:4000/appointments?limit=500", {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  async function completeAppointment(appointmentId: string) {
    ...
    try {
      const res = await fetch(`http://127.0.0.1:4000/appointments/${appointmentId}/complete`, {
        method: "POST",
        headers: {
  ...
  async function cancelAppointment(appointmentId: string) {
    ...
    try {
      const res = await fetch(`http://127.0.0.1:4000/appointments/${appointmentId}/cancel`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`
  ...
  async function deleteAppointment(appointmentId: string) {
    ...
    try {
      const res = await fetch(`http://127.0.0.1:4000/appointments/${appointmentId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`
        }
  ...
  async function submitReschedule() {
    ...
    try {
      const res = await fetch(`http://127.0.0.1:4000/appointments/${rescheduleTarget.id}/reschedule`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`
  ...
  async function bookAppointment() {
    ...
    try {
      ...
      const res = await fetch("http://127.0.0.1:4000/appointments/reception/book", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`
